...
class PersistentMemory:
    ...
    def __init__(self, collection_name: str = "research_memory", persist_directory: str = "./.chroma_db"):
        self.client = chromadb.PersistentClient(path=persist_directory)
        self.collection = self.client.get_or_create_collection(name=collection_name)
        
    def store(self, document: str, metadata: Dict[str, Any] = None, doc_id: str = None) -> str:
        """
